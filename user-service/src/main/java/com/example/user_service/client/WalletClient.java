...
public class WalletClient {
    ...
    public Wallet createDefaultWalletForUser(Long userId, String username) {
        ...
        walletDTO.setInitialBalance(BigDecimal.ZERO);
         ...
         Wallet createdWallet =  restClient.post()
                .uri(walletServiceUrl + "/api/wallets/user/{userId}/create-wallet", userId)
                .body(walletDTO)
                .retrieve()
                .body(Wallet.class);// ✅ Expect Wallet in response

        System.out.println("✅ Created wallet from wallet-service: " + createdWallet);
